...
1. **Event Title Input**
   ...
   - Placeholder: "What will the BTC price be on December 31, 2025?"
...
3. **Category Selector**
   ...
   - Options: Crypto, Politics, Sports, Science, Economics, Technology, Other
...
1. **Outcome Variable Name**
   - Type: Text input
   - Example: "BTC Price (USD)" | "Temperature (°F)" | "Date"
